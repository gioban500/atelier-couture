    ...
    const loadPortfolio = async () => {
      try {
        const [portfolioRes, categoriesRes] = await Promise.all([
          fetch('https://atelier-couture-3954.onrender.com/api/portfolio', { signal: controller.signal }),
          fetch('https://atelier-couture-3954.onrender.com/api/portfolio/categories', { signal: controller.signal })
        ]);
