...
export default function Login() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch('http://atelierBack.miabetepe.com/api/auth/login', {
        method: 'POST',
  ...
  const handleForgotPassword = async (e) => {
    ...
    try {
      const response = await fetch('http://atelierBack.miabetepe.com/api/auth/forgot-password', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
